package com.lksnext.ParkingJDorronsoro.notifications
 ...
 * [NotificacionService], siguiendo el patrón interfaz + impl del proyecto.
 */
@AndroidEntryPoint
class AparkauMessagingService : FirebaseMessagingService() {
